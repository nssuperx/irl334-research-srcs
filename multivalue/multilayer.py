...
hp = HyperParameter(2022, 31, 15, 20, 10, 1e-3, 10, 200)
...
def main():
    ...
    # 何もしていない最初の状態
    show_brick_weight_allInOnePicture(model.in_mvbrick.fc, hp.in_bricks, hp.in_brick_classes, 0, workdir)
    ...
    for t in range(hp.epochs):
        ...
        accuracy.append(acc)
        avg_loss.append(al)
        show_brick_weight_allInOnePicture(model.in_mvbrick.fc, hp.in_bricks, hp.in_brick_classes, t+1, workdir)
    print("Done!")
